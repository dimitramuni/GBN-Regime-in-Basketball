...
str(abndata)
abndata[,c(1,3,4,7,8)] <- as.data.frame(lapply(abndata[,c(1,3,4,7,8)], factor))
...
Repeat step 5 for incremental parent limit (e.g. 1 to nr.var-1). The optimal DAG is the one where the network score does not
improve (i.e. becomes bigger) any longer by allowing more parents.  
