...
#reference: https://statistircsglobe.com/display-all-x-axis-labels-of-barplot-in-r
chicago<-barplot(roster_changes$CHI~roster_changes$Season,las=3,cex.names=0.7,ylim=c(0.0,1.0),
...
lakers<-barplot(roster_changes$LAL[from_Season:to_Season]~roster_changes$Season[from_Season:to_Season],las=3,cex.names=0.67,ylim=c(0.0,1.0),
