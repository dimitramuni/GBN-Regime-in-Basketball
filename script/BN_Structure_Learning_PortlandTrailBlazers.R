...
write.csv(gamelog_stat_portland,'PreProcessed_Chicago_Gamelog.csv',row.names = FALSE)
...
start_time<-Sys.time()
Identify_Positions_hc(data = gamelog_discrete_portland,k=3,n_iteration = 20000)
end_time<-Sys.time()
