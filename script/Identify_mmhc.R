...
Identify_Positions_mmhc<-function(data,k,n_iteration){
  ...
  repeat{                  #L9
    ...
    loglikelihood_D_current_nonzero_deltas=sum(sapply(D_current,Loglikelihood_Calculation_mmhc))
    ...
    loglikelihood_D_proposal_nonzero_deltas=sum(sapply(D_proposal,Loglikelihood_Calculation_mmhc))
    #  for (i in 1:n2) {
